...
//     // FETCH STUDENT
//     //
//     // The parent/user ID is used to verify
//     // that this student belongs to the
...
//     const subjects = student.studentScores.map(
//       (score) => ({
//         id: score.subjectId,
